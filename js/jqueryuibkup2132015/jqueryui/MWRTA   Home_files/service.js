	...
	function getService() {
        ...
        query.find({
			success:function(results) {
				...
				var x = "<div id='bar'><h3>Service Announcements ("+count+") ";
				if (count > 0){
					x += "";
					}
...
$('#bar').css({"background-color":"none", "position":"relative", "margin-top": "-2px","color": "white", /*"width": "100%",*/ "line-height": "40px", "z-index": "999", "margin":"0 auto", "text-align":"left"});
